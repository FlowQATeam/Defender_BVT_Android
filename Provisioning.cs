...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Touch", "(Optional Action)\r\nTouch item 'ComPentairPentairhome.UIWindow.AddADevice' at Center", repo.ComPentairPentairhome.UIWindow.AddADeviceInfo, new RecordItemIndex(1));
            ...
            try {
                Report.Log(ReportLevel.Info, "Touch", "(Optional Action)\r\nTouch item 'ComPentairPentairhome.AddADevicedevice' at Center", repo.ComPentairPentairhome.AddADevicedeviceInfo, new RecordItemIndex(3));
                repo.ComPentairPentairhome.AddADevicedevice.Touch();
                Delay.Milliseconds(300);
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.UIWindow.SumpController' at Center", repo.ComPentairPentairhome.UIWindow.SumpControllerInfo, new RecordItemIndex(5));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.UIWindow.ContinueonProvisiom' at Center", repo.ComPentairPentairhome.UIWindow.ContinueonProvisiomInfo, new RecordItemIndex(7));
            ...
            Report.Log(ReportLevel.Info, "Touch gestures", "Swipe gesture with direction 'Up (270°)' starting from 'Center' with distance '.5' with swipe duration'500ms' and step count '0' on item 'ComPentairPentairhome.setupBluetoothScerollUp'.", repo.ComPentairPentairhome.setupBluetoothScerollUpInfo, new RecordItemIndex(9));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.UIWindow.BluetoothContinue' at Center", repo.ComPentairPentairhome.UIWindow.BluetoothContinueInfo, new RecordItemIndex(11));
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 30s to exist. Associated repository item: 'ComPentairPentairhome.UIWindow.DeviceSelection'", repo.ComPentairPentairhome.UIWindow.DeviceSelectionInfo, new ActionTimeout(30000), new RecordItemIndex(13));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.UIWindow.DeviceSelection' at Center", repo.ComPentairPentairhome.UIWindow.DeviceSelectionInfo, new RecordItemIndex(15));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.UIWindow.ConnectionEstablishedContinue' at Center", repo.ComPentairPentairhome.UIWindow.ConnectionEstablishedContinueInfo, new RecordItemIndex(17));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.UIWindow.WifiSelection' at Center", repo.ComPentairPentairhome.UIWindow.WifiSelectionInfo, new RecordItemIndex(19));
            repo.ComPentairPentairhome.UIWindow.WifiSelection.Touch();
            Delay.Milliseconds(300);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 4s.", new RecordItemIndex(20));
            Delay.Duration(4000, false);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '$WifiPassword' on item 'ComPentairPentairhome.UIWindow.WifiPasswordinput'.", repo.ComPentairPentairhome.UIWindow.WifiPasswordinputInfo, new RecordItemIndex(21));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.UIWindow.WifiContinue' at Center", repo.ComPentairPentairhome.UIWindow.WifiContinueInfo, new RecordItemIndex(23));
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking Touch() on item 'ComPentairPentairhome.UIWindow.AddressContinue'.", repo.ComPentairPentairhome.UIWindow.AddressContinueInfo, new RecordItemIndex(25));
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking Touch() on item 'ComPentairPentairhome.UIWindow.NicknameInput'.", repo.ComPentairPentairhome.UIWindow.NicknameInputInfo, new RecordItemIndex(27));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '' on item 'ComPentairPentairhome.UIWindow.NicknameInput'.", repo.ComPentairPentairhome.UIWindow.NicknameInputInfo, new RecordItemIndex(29));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '$Nickname' on item 'ComPentairPentairhome.UIWindow.NicknameInput'.", repo.ComPentairPentairhome.UIWindow.NicknameInputInfo, new RecordItemIndex(31));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.UIWindow.NicknameSave' at Center", repo.ComPentairPentairhome.UIWindow.NicknameSaveInfo, new RecordItemIndex(33));
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking Touch() on item 'ComPentairPentairhome.UIWindow.InstallationCompleteContinue'.", repo.ComPentairPentairhome.UIWindow.InstallationCompleteContinueInfo, new RecordItemIndex(35));
            ...
            try {
                Report.Log(ReportLevel.Info, "Touch", "(Optional Action)\r\nTouch item 'ComPentairPentairhome.NotificationsContinue' at Center", repo.ComPentairPentairhome.NotificationsContinueInfo, new RecordItemIndex(37));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'ComPentairPentairhome.HomeIcon' at Center", repo.ComPentairPentairhome.HomeIconInfo, new RecordItemIndex(39));
            ...
            try {
                Report.Log(ReportLevel.Info, "Touch", "(Optional Action)\r\nTouch item 'ComPentairPentairhome.AppFeedbackClose' at Center", repo.ComPentairPentairhome.AppFeedbackCloseInfo, new RecordItemIndex(41));
            ...
            Report.Screenshot(ReportLevel.Info, "User", "Home Dashboard", repo.ComPentairPentairhome.UIWindow.ScreenShot, false, new RecordItemIndex(43));
